...
exports.countlikechange = functions.database.ref('/posts/{postid}').onWrite(
    async (change) => {
...
// If the number of posts gets deleted, recount the number of posts
exports.recountposts = functions.database.ref('/posts/{postid}').onDelete(async (snap) => {
